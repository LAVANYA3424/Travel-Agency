         ...
         <div class="header-main">
            <div class="menu-mobile">
                <ul class="nav-links nav navbar-nav">
                    ...
                    <li class="dropdown active"><a href="<?php print url('/hotel') ; ?>" class="main-menu"><span class="text">Hôtels</span></a><span class="icons-dropdown"><i class="fa fa-angle-down"></i></span>
                    </li>
...
<div class="header-main">
                            ...
                            <nav class="navigation">
                                <ul class="nav-links nav navbar-nav">
                                   ...
                                   <li class="dropdown"><a href="<?php print url('/travels') ; ?>" class="main-menu"><span class="text"> Séjours</span><span class="icons-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                       ...
                                       <li class="dropdown active"><a href="<?php print url('hotel') ; ?>" class="main-menu"><span class="text">Hôtels</span><span class="icons-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                    </li>
        ...
        <!-- WRAPPER-->
            ...
            <div class="main-content">
                 <?php $src = image_style_url('slide_1600x500',$data['travel']->field_imagehotel['und'][0]['filename']) ?>
                <section class="page-banner hotel-result" style="background-image : url('<?php print $src ; ?>')">
                    <div class="container">
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb">
                                    <li><a href="<?php print url($lien) ; ?>" class="link home">Accueil</a></li>
                                    <li><a href="<?php print url('/travels') ; ?>" class="link">Hôtel</a></li>
                                ...
                                <div class="price"> <span class="text">from</span> <span class="number"> <?php print $data['travel']->field_pricehotel['und'][0]['value']; ?> </span><sup class="unit">MAD</sup></div>
                            </div>
                        </div>
                    </div>
                </section>