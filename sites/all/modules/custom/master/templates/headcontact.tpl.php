    ...
    <div class="wrapper-content"><!-- HEADER-->
                            ...
                            <nav class="navigation">
                                <ul class="nav-links nav navbar-nav">
                                   ...
                                   <li class="dropdown"><a href="<?php print url('/travels') ; ?>" class="main-menu"><span class="text"> Séjours</span><span class="icons-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                    ...
                                    <li class="dropdown active"><a href="<?php print url('contactfav') ; ?>" class="main-menu"><span class="text">Contactez-Nous</span></a></li>
                                                                    </ul>
        ...
        <div id="wrapper-content"><!-- MAIN CONTENT-->
            <div class="main-content">
                <section class="page-banner contact-page " style="background-image : url('<?php print $data['image'] ; ?>')">
                    <div class="container">
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb">
                                    <li><a href="<?php print url($lien) ; ?>" class="link home">Accueil</a></li>
                                    <li class="active"><a href="#" class="link">contactez-nous</a></li>
                                </ol>
                                <div class="clearfix"></div>
