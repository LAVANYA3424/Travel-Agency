                            ...
                            <nav class="navigation">
                                <ul class="nav-links nav navbar-nav">
                                   ...
                                   <li class="dropdown"><a href="<?php print url('/travels') ; ?>" class="main-menu"><span class="text"> Séjours</span><span class="icons-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                       ...
                                       <li class="dropdown active"><a href="<?php print url('/tourislamic') ; ?>" class="main-menu"><span class="text">Hajj_Omra</span><span class="icons-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                                                           </li>   
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><a href="#" class="link">Hajj_Omra</a></li>
                                </ol>
                                <div class="clearfix"></div>
                                <h4 class="captions">hajj&Omra</h4></div>
                        </div>
                    </div>
                </section>