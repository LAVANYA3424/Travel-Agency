         ...
         <div class="header-main">
            <div class="menu-mobile">
                <ul class="nav-links nav navbar-nav">
                  ...
                  <li class="dropdown active"><a href="<?php print url('/aboutfav') ; ?>" class="main-menu"><span class="text">À propos </span></a></li>
...
<div class="header-main">
        ...
        <div id="wrapper-content"><!-- MAIN CONTENT-->
            <div class="main-content">
                <section class="page-banner about-us-page" style="background-image : url('<?php print $data['image'] ; ?>')">
                    <div class="container">
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb">
                                    <li><a href="<?php print url($lien) ; ?>" class="link home">Accueil</a></li>
                                    <li class="active"><a href="#" class="link">À propos</a></li>
                                </ol>
                                <div class="clearfix"></div>
                                <h2 class="captions"> À propos </h2></div>
                        </div>
                    </div>
                </section>