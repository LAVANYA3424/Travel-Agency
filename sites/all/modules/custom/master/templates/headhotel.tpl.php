    ...
    <div class="wrapper-content"><!-- HEADER-->
        ...
        <div id="wrapper-content"><!-- MAIN CONTENT-->
            <div class="main-content">
                <section class="page-banner hotel-result" style="background-image : url('<?php print $data['image'] ; ?>')">
                    <div class="container">
                        <div class="page-title-wrapper">
                            <div class="page-title-content">
                                <ol class="breadcrumb">
                                    <li><a href="<?php print url($lien) ; ?>" class="link home">Accueil</a></li>
                                    <li class="active"><a href="#" class="link">Hôtels</a></li>
                                </ol>
                                <div class="clearfix"></div>
                                <h2 class="captions">HôTEL</h2></div>
                        </div>
                    </div>
                </section>