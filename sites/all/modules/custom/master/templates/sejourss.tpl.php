                    ...
                    <div class="container">
                        <div class="tours-wrapper">
                            <div class="group-title">
                                <div class="sub-title"><p class="text">préparez-vous </p><i class="icons flaticon-people"></i></div>
                                <h2 class="main-title">
TOURS IMPRESSIONNANTS</h2></div>
                            <div class="tours-content margin-top70">
                                ...
                                <a href="<?php print url('/travels') ; ?>" class="btn btn-transparent margin-top70"> Plus</a></div>
                        </div>
                    </div>
                </section>
