...
<div id="wrap">
  ...
  <footer id="copyright-wrap" class="clear">
    <div id="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('Powred by'); ?>  <a href="http://www.smartbeeagency.com" title="Smartbee" target="_blank">Smartbee</a>.</div>
  </footer>
</div>